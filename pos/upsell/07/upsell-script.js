...
function startLoadingSequence() {
    ...
    // Step 2: Geração de NF
    setTimeout(() => {
        processStep(2, 'NF Gerada com Sucesso ✓', 2000);
    }, 2500);
    
    // Step 3: Validação Fiscal
    setTimeout(() => {
        processStep(3, 'Validação Concluída ✓', 1500);
    }, 5000);
...
function redirectToAccountPayment() {
    ...
    // O link de pagamento real do Upsell 07
