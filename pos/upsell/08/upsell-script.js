...
function startLoadingSequence() {
    ...
    setTimeout(() => {
        processStep(1, 'Score Consultado ✓', 1500);
    }, 500);
    
    // Step 2: Análise de Risco
    setTimeout(() => {
        processStep(2, 'Risco Identificado ✓', 2000);
    }, 2500);
    
    // Step 3: Mitigação de Risco
    setTimeout(() => {
        processStep(3, 'Solução Disponível ✓', 1500);
    }, 5000);
...
function redirectToAccountPayment() {
    ...
    // O link de pagamento real do Upsell 08
